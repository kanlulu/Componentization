...
import com.yql.common.base.DataBindingBaseActivity;
import com.yql.common.utils.PrefsUtils;
import com.yql.moduleMain.R;
import com.yql.moduleMain.databinding.ActivityGuideBinding;
 ...
 * @version V1.0
 * @Title
 * @Package com.hyd.paydayloan.ui.start
 * @Description
 * @date 2017/8/8 10:41
 */
...
public class GuideActivity extends DataBindingBaseActivity<ActivityGuideBinding> implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        image1.setImageResource(R.mipmap.guide01);
